...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="view_food_items.php" class="list-group-item ">View service Items</a>
    		<a href="add_food_items.php" class="list-group-item ">Add service Items</a>
    		<a href="edit_food_items.php" class="list-group-item active">Edit service Items</a>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDIT YOUR service ITEMS HERE </h3>
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> service Name: </label>
            <input type="text" class="form-control" id="dname" name="dname" value=<?php echo $row1['name'];  ?> placeholder="Your Food name" required="">
          </div>     

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> service Price: </label>
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> service Description: </label>
